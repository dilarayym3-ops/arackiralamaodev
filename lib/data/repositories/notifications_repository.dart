...
class NotificationsRepository {
  ...
  Future<void> checkUpcomingRentalDeadlines(int subeId) async {
    ...
    for (final r in upcoming) {
      ...
      String cat = 'Kiralama';
      if (gunKaldi < 0) {
        msg = 'GECIKMIS:  Kiralama #$kiralamaId ($plaka - $marka $model) ${-gunKaldi} gun gecikti!';
        cat = 'Uyari';
      } else if (gunKaldi == 0) {
        msg = 'BUGUN TESLIM: Kiralama #$kiralamaId ($plaka - $marka $model) bugun teslim edilmeli!';
        cat = 'Uyari';
      } else {
        msg = 'Yaklasan Teslim: Kiralama #$kiralamaId ($plaka - $marka $model) $gunKaldi gun kaldi';
      }
