              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Ceza/Kiralama/Plaka/Marka/Model ara...',
              ...
              children: [
                ...
                Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: ['Tümü', 'Ödendi', 'Kısmi', 'Ödenmedi']
                        .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                        .toList(),
                    onChanged: (v) {
                      _filterPayStatus = v ?? 'Tümü';
                      _applyFilters();
                    },
                  ),
                ]),
                Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  DropdownButton<String>(
                    ...
                    items: _cezaTurleri.map((e) => DropdownMenuItem(value: e, child: Text(e.length > 20 ? '${e.substring(0, 20)}...' : e))).toList(),
                    onChanged: (v) {
                      _filterCezaTuru = v ?? 'Tümü';
                      _applyFilters();
                    },
                  ),
                ]),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            OutlinedButton.icon(
              ...
              label: Text(selRental == null ? 'Kiralama Seç' : 'Kiralama#${selRental!['KIRALAMA_ID']}'),
            ),
            const SizedBox(height: 8),
            ...
            Wrap(spacing: 8, runSpacing: 8, children: [
              ...
              TextButton.icon(onPressed: () { setState(() { _selected = null; selRental = null; fTarih.text = DateTime.now().toString().substring(0, 10); fTur.clear(); fTutar.clear(); }); }, icon: const Icon(Icons.clear), label: const Text('Temizle')),
            ]),
            if (_selected != null) ...[
              ...
              _buildDetailRow('Ödeme Durumu', '${_selected!['PAY_STATUS'] ?? 'Yok'}'),
            ],
          ]),
        ),
      ),
